...
// Import saviyntRoutes for API endpoints
import { saviyntRoutes } from './routes/saviyntRoutes';
// Import Logger for logging server events
import { Logger } from './utils/logger';

/**
 * Main Koa application for SaviyntWrapper
 * @class
 */
export class App {
  ...
  private configure(): void {
    ...
    // Mount Saviynt routes
    this.app.use(saviyntRoutes().routes()).use(saviyntRoutes().allowedMethods());
